"use strict";let Cu=Components.utils;let Ci=Components.interfaces;let Cc=Components.classes;Cu.import("resource://gre/modules/XPCOMUtils.jsm");Cu.import("resource://gre/modules/Services.jsm");const MESSAGES_IN_INTERVAL=1500
const STORAGE_MAX_EVENTS=200;var _consoleStorage=new Map();const CONSOLEAPISTORAGE_CID=Components.ID('{96cf7855-dfa9-4c6d-8276-f9705b4890f2}');function ConsoleAPIStorageService(){this.init();}
...
return result.sort(function(a,b){return a.timeStamp-b.timeStamp;});},recordEvent:function CS_recordEvent(aId,aOuterId,aEvent)
...
Services.obs.notifyObservers(aEvent,"console-api-log-event",aOuterId);Services.obs.notifyObservers(aEvent,"console-storage-cache-event",aId);},clearEvents:function CS_clearEvents(aId)
