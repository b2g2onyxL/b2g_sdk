...
continue;if(!(result.addon.type in AddonManager.addonTypes)){continue;}
results.push(result); ids.splice(idIndex,1);}
...
switch(localName){case"type":

let id=parseInt(node.getAttribute("id"));switch(id){case 1:addon.type="extension";break;case 2:addon.type="theme";break;case 3:addon.type="dictionary";break;case 4:addon.type="search";break;case 5:case 6:addon.type="locale";break;case 7:addon.type="plugin";break;case 8:addon.type="api";break;case 9:addon.type="lightweight-theme";break;case 11:addon.type="webapp";break;default:logger.info("Unknown type id "+id+" found when parsing response for GUID "+guid);}
...
continue;if(!(result.addon.type in AddonManager.addonTypes))
...
results.forEach(function(aResult){let addon=aResult.addon;let callback=function addonInstallCallback(aInstall){addon.install=aInstall;pendingResults--;if(pendingResults==0)
