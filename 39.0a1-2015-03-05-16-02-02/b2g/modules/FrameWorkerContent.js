...
catch(e){Cu.reportError("FrameWorker: failed to import API "+fn+"\n"+e+"\n");}});let navigator=Cu.cloneInto({ appName:workerWindow.navigator.appName,appVersion:workerWindow.navigator.appVersion,platform:workerWindow.navigator.platform,userAgent:workerWindow.navigator.userAgent,},sandbox);Object.defineProperty(Cu.waiveXrays(navigator),'onLine',{configurable:true,enumerable:true,get:Cu.exportFunction(()=>workerWindow.navigator.onLine,sandbox)});sandbox.navigator=navigator;
