'use strict';module.metadata={"stability":"experimental"};const{Class}=require('../core/heritage');const listNS=require('../core/namespace').ns();const listOptions={initialize:function List(){listNS(this).keyValueMap=[];for(let i=0,ii=arguments.length;i<ii;i++)
