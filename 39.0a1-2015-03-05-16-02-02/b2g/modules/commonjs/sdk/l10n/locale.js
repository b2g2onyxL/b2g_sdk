...
addLocale(browserUiLocale); let contentLocales=prefs.getLocalized(PREF_ACCEPT_LANGUAGES,"")||prefs.get(PREF_ACCEPT_LANGUAGES,"");if(contentLocales){ for(let locale of contentLocales.split(","))
