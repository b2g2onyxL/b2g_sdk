...
command=args.join(' ');environment=environment||[];if(environment.length){
 environment=ctypes.char16_t.array()(environment.join('\0')+'\0');}else{environment=null;}
