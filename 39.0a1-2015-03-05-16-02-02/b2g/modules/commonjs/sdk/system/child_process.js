...
exports.exec=exec;function execFile(file,...args){let cmdArgs=[],callback; let options={cwd:null,env:null,encoding:'utf8',timeout:0,maxBuffer:204800,killSignal:'SIGTERM'};if(isFunction(args[args.length-1]))
