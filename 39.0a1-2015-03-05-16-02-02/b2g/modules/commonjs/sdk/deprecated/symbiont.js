...
let eventName='end'==this.contentScriptWhen?'load':'DOMContentLoaded';this._loadEvent=eventName;frame.addEventListener(eventName,this._loadListener=function _onReady(event){if(event.target!=frame.contentDocument)
